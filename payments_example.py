...
def command_start(message):
    bot.send_message(message.chat.id,
                     "Hello, I'm the demo merchant商人 bot."
                     " I can sell you a Time Machine."
                     " Use /buy to order one, /terms for Terms and Conditions")


@bot.message_handler(commands=['terms'])    # Terms條款
def command_terms(message):
    bot.send_message(
        message.chat.id,
        'Thank you for shopping購物 with our demo bot.\n'
        'We hope you like your new time machine!\n'
...
def command_pay(message):
    ...
    bot.send_invoice(
        ...
        # description
        ' Want to visit your great-great-great-grandparents? '
        'Make a fortune at the races? '
        'Shake hands with Hammurabi and take a stroll in the Hanging Gardens? '
        'Order our Working Time Machine today!',
        'HAPPY FRIDAYS COUPON優惠券',    # invoice_payload
